...
def paper_example():
    v1 = [4.1, 7.7, 17.5, 31.4, 32.7, 40.6, 92.4, 115.3, 118.3, 119.0, 129.6,
            198.6, 200.7, 242.5, 255.0, 274.7, 274.7, 302.8, 334.1, 430.0,
            489.1, 703.4, 978.0, 1656.0, 1697.8, 2745.6]
    v2 = [1.0, 4.9, 4.9, 11.5, 17.3, 21.7, 24.4, 26.1, 26.3, 28.6, 29.0, 36.6,
            41.1, 47.3, 68.5, 81.2, 87.0, 95.0, 147.8, 163.0, 244.3, 321.2,
            345.5, 372.4, 830.1, 1202.6]
    zj = 2.184
